...
<div data-vc-full-width="true" data-vc-full-width-init="false" class="vc_row wpb_row vc_row-fluid branner-product vc_row-has-fill ">
    <div class="wpb_column vc_column_container vc_col-sm-12 ">
        ...
        <div id="page" class="site">
         ...
         <div class="tile" data-scale="1.1" data-image="{{ asset('assets/custom/images/product/psf/1.jpg')}}"></div>
                <!-- wraper_shop_single -->
                                ...
                                <div class="shop_single">
                                    <div id="product-3981" class="post-3981 product type-product status-publish has-post-thumbnail product_cat-general product_tag-invitation first instock shipping-taxable purchasable product-type-simple">
                                            ...
                                            <figure class="woocommerce-product-gallery__wrapper">
                                                 <div class="woocommerce-product-gallery__image product-details-big-image-slider-wrapper"style="margin-bottom:15px;">
                                                     ...
                                                     <div class="single-image">
                                                        <img id="showfancy" data-zoom-image="{{ asset('assets/custom/images/product/psf/1.jpg')}}"  width="600" src="{{ asset('assets/custom/images/product/psf/1.jpg')}}" data-fancybox="images" data-caption="My caption" class="attachment-woocommerce_single size-woocommerce_single wp-post-image " alt="Polyester Staple Fiber6" data-caption="" data-src="{{ asset('assets/custom/images/product/psf/1.jpg')}}" data-large_image_width="600" data-large_image_height="800" >
                                                    </div>
                                               ...
                                               <!--  {{-- <div class="clients owl-carousel element-one owl-nav-style-one owl-dot-style-one " data-owl-nav="false" data-owl-dots="false" data-owl-loop="true" data-owl-autoplay="true" data-owl-autoplay-timeout="6" data-owl-mobile-items="3" data-owl-tab-items="3" data-owl-desktop-items="3"> --}} -->
                                                    ...
                                                    for ($i=1; $i < 6 ; $i++) { ?>
                                                         <div class="woocommerce-product-gallery__image single-image single-image-select">
                                                            ...
                                                            <img id="p{{$i}}" width="600" data-zoom-image="{{ asset('assets/custom/images/product/psf/'.$i.'.jpg')}}" src="{{ asset('assets/custom/images/product/psf/'.$i.'.jpg')}}" class="attachment-woocommerce_single size-woocommerce_single bdcolor" alt="Polyester Staple Fiber7"  data-caption="" data-src="{{ asset('assets/custom/images/product/psf/'.$i.'.jpg')}}" data-large_image_width="600" data-large_image_height="800" >
                                        ...
                                        <div class="summary entry-summary">
                                            <h1 class="product_title entry-title mb-font24">PSF (Polyester Staple Fiber)</h1>
                                            ...
                                            <div class="woocommerce-product-details__short-description">
                                                <div class="woocommerce-product-details__short-description">
                                                    <div class="row mb-2">
                                                        ...
                                                        <div class="col-7 col-sm-9 mb-margin-left8 ipad-marginleft0"style="margin-left: -8%;"><p>350 kgs a bale </p><p> 36 bales /20’FCL </p> <p>72 bales /40’FCL</p></div>
                                                    </div>
                                            ...
                                            <table class="table table-sm pc-margin-top15">
                                                <tr>
                                                    <th colspan="3"class="text-center">PSF</th>
                                                </tr>
                                                <tr>
                                                    <td><p style="font-size:14px;">0.8 d x 32 mm.</p></td>
                                                    <td><p style="font-size:14px;">1.0 d X 32 mm.</p></td>
                                                    <td><p style="font-size:14px;">1.2 d X 32 mm.</p></td>
                                                </tr>
                                                <tr>
                                                    <td><p style="font-size:14px;">0.8 d X 38 mm.</p></td>
                                                    <td><p style="font-size:14px;">1.0 d X 38 mm.</p></td>
                                                    <td><p style="font-size:14px;">1.2 d X 32 mm.</p></td>
                                                </tr>
                                                <tr>
                                                    <td><p style="font-size:14px;">0.8  d X 51 mm.</p></td>
                                                    <td><p style="font-size:14px;">1.0 d X 51 mm.</p></td>
                                                    <td><p style="font-size:14px;">1.2 d X 51 mm.</p></td>
                                                </tr>
