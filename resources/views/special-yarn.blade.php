...
<div data-vc-full-width="true" data-vc-full-width-init="false" class="vc_row wpb_row vc_row-fluid branner-product vc_row-has-fill ">
    <div class="wpb_column vc_column_container vc_col-sm-12 ">
        ...
        <div id="page" class="site">
         ...
         <div class="tile" data-scale="1.1" data-image="{{ asset('assets/custom/images/product/mono/1.jpg')}}"></div>
                <!-- wraper_shop_single -->
                                ...
                                <div class="shop_single">
                                    <div id="product-3981" class="post-3981 product type-product status-publish has-post-thumbnail product_cat-general product_tag-invitation first instock shipping-taxable purchasable product-type-simple">
                                            ...
                                            <figure class="woocommerce-product-gallery__wrapper">
                                                 <div class="woocommerce-product-gallery__image product-details-big-image-slider-wrapper"style="margin-bottom:15px;">
                                                     ...
                                                     <div class="single-image">
                                                        <img id="showfancy" data-zoom-image="{{ asset('assets/custom/images/product/mono/1.jpg')}}"  width="600" src="{{ asset('assets/custom/images/product/mono/1.jpg')}}" data-fancybox="images" data-caption="My caption" class="attachment-woocommerce_single size-woocommerce_single wp-post-image " alt="Monofilament6"  data-caption="" data-src="{{ asset('assets/custom/images/product/mono/1.jpg')}}" data-large_image_width="600" data-large_image_height="800" >
                                                    </div>
                                               ...
                                               <!--  {{-- <div class="clients owl-carousel element-one owl-nav-style-one owl-dot-style-one " data-owl-nav="false" data-owl-dots="false" data-owl-loop="true" data-owl-autoplay="true" data-owl-autoplay-timeout="6" data-owl-mobile-items="3" data-owl-tab-items="3" data-owl-desktop-items="3"> --}} -->
                                                    ...
                                                    for ($i=1; $i < 3 ; $i++) { ?>
                                                         <div class="woocommerce-product-gallery__image single-image single-image-select">
                                                            ...
                                                            <img id="p{{$i}}" width="600" data-zoom-image="{{ asset('assets/custom/images/product/mono/'.$i.'.jpg')}}" src="{{ asset('assets/custom/images/product/mono/'.$i.'.jpg')}}" class="attachment-woocommerce_single size-woocommerce_single bdcolor" alt="Monofilament7"  data-caption="" data-src="{{ asset('assets/custom/images/product/mono/'.$i.'.jpg')}}" data-large_image_width="600" data-large_image_height="800" >
                                        ...
                                        <div class="summary entry-summary">
                                            <h1 class="product_title entry-title mb-font24">Monofilament</h1>
                                            <h2 class="h2seo"><span class="woocommerce-Price-amount amount">100% Polyester monofilament semi-dull, raw white </span>
                                            </h2>
                                            <div class="woocommerce-product-details__short-description">
                                                <div class="woocommerce-product-details__short-description">
                                                     <div class="row mb-2">
                                                        <div class="col-5 col-md-3"><p>Packing :</p></div>
                                                        <div class="col-7 col-sm-9 mb-margin-left8 ipad-marginleft0" style="margin-left: -8%;"><p>around 2kg on cheese</p><p> 12 cheeses a carton</p> <p>335 cartons / 20’FCL</p><p>833 cartons /40’HC</p></div>
                                                    </div>
                                            ...
                                            <table class="table table-sm pc-margin-top15">
                                                <tr>
                                                    <th colspan="2"class="text-center">Monofilament</th>
                                                </tr>
                                                <tr>
