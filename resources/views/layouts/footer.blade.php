                        ...
                        <div class="content fp-0">
                            ...
                            <ul class="company_lists">
                                <li>
                                    <div class="icon">
                                        <picture>
                                            <source srcset="/assets/images/footer/mobile/Logo-Footer-TPC.webp" media="(max-width: 640px)">
                                            <img src="/assets/images/footer/desktop/Logo-Footer-TPC.webp" width="900" height="350" class="img-fluid" alt="Thai Polyester">
                                        </picture>
                                    </div>
                                    <a href="/" title="Thai Polyester"><h3>Thai Polyester</h3></a>
                                </li>
                                <li>
                                    <div class="icon">
                                        <picture>
                                            <source srcset="/assets/images/footer/mobile/Logo-Jongstit-Footer.webp" media="(max-width: 640px)">
                                            <img src="/assets/images/footer/desktop/Logo-Jongstit-Footer.webp" width="900" height="350" class="img-fluid" alt="Jongstit">
                                        </picture>
                                    </div>
                                    <a href="http://www.jongstit.com" title="Jong stit"><h3>Jong stit</h3></a>
                                </li>
                                <li>
                                    <div class="icon">
                                        <picture>
                                            <source srcset="/assets/images/footer/mobile/Logo-fashionhometex-Footer.webp" media="(max-width: 640px)">
                                            <img src="/assets/images/footer/desktop/Logo-fashionhometex-Footer.webp" width="900" height="350" class="img-fluid" alt="fashionhometex">
                                        </picture>
                                    </div>
                                    <a href="http://www.fashionhometex.com/" title="Fashion Hometex"><h3>Fashion Hometex</h3></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                </div>
				<div class="col-xs-12 col-sm-12 col-md-3 col_form">
                    <div class="form_group">
                        <div class="title">
                            <h2 class="text-center"><strong>CONTACT US</strong></h2>
                        </div>
                        <form id="f-contact-form" data-request="contact" autocomplete="off">
                            ...
                            <div class="form-group col-xs-12 col-sm-12 col-md-12 text-center">
                                <button type="button" id="f-submitcontract" class="bt-contact">SEND</button>
                            </div>
                        </form>
                    </div>
                </div>
