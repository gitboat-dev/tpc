            ...
            <div class="row">
                ...
                <div class="col-xs-5 col-sm-5 col-md-3 p-0 col2">
                    <div class="img_block pos-ab">
                        <picture>
                            <source srcset="/assets/images/psf/mobile/PSF-Product-Thaipolyester.webp" alt="" media="(max-width: 640px)">
                            <img src="/assets/images/psf/desktop/PSF-Product-Thaipolyester.webp" width="900" height="350" class="img-fluid" alt="">
                        </picture>
                    </div>
                </div>
                ...
                <div class="owl-carousel owl-theme">
                    <div class="item p-0">
                        <div class="content bg-white">
                            <a href="/assets/images/psf/desktop/Nonwoven-for-geo-textile-and-medical-applications-Thaipolyester-ใหญ่.webp" title="Nonwoven for geo textile and medical applications Thaipolyester" data-fancybox="gallery">
                                <picture>
                                    <source srcset="/assets/images/psf/mobile/Nonwoven-for-geo-textile-and-medical-applications-Thaipolyester.webp"  media="(max-width: 640px)" loading="lazy">
                                    <img src="/assets/images/psf/desktop/Nonwoven-for-geo-textile-and-medical-applications-Thaipolyester.webp" width="900" height="350" class="img-fluid" alt="Nonwoven for geo textile and medical applications Thaipolyester" loading="lazy">
                                </picture>
                    ...
                    <div class="item p-0">
                        <div class="content bg-white">
                            <a href="/assets/images/psf/desktop/Home-textile-for-filling-pillows-Thaipolyester-ใหญ่.webp" title="Home textile for filling pillows Thaipolyester" data-fancybox="gallery">
                                <picture>
                                    <source srcset="/assets/images/psf/mobile/Home-textile-for-filling-pillows-Thaipolyester.webp"  media="(max-width: 640px)" loading="lazy">
                                    <img src="/assets/images/psf/desktop/Home-textile-for-filling-pillows-Thaipolyester.webp" width="900" height="350" class="img-fluid" alt="Home textile for filling pillows Thaipolyester" loading="lazy">
                                </picture>
                                <div class="text d-flex">
                                    <p>
                    ...
                    <div class="item p-0">
                        <div class="content bg-white">
                            <a href="/assets/images/psf/desktop/Toy-industry-for-filling-soft-toys-Thaipolyester-ใหญ่.webp" title="Toy industry for filling soft toys Thaipolyester" data-fancybox="gallery">
                                <picture>
                                    <source srcset="/assets/images/psf/mobile/Toy-industry-for-filling-soft-toys-Thaipolyester.webp"  media="(max-width: 640px)" loading="lazy">
                                    <img src="/assets/images/psf/desktop/Toy-industry-for-filling-soft-toys-Thaipolyester.webp" width="900" height="350" class="img-fluid" alt="Toy industry for filling soft toys Thaipolyester" loading="lazy">
                                </picture>
                                <div class="text d-flex">
                                    <p>
                    ...
                    <div class="item p-0">
                        <div class="content bg-white">
                            <a href="/assets/images/psf/desktop/Home-furnishings-for-carpets,-mattresses,-bedsheets,-etc-Thaipolyester-ใหญ่.webp" title="Home furnishings for carpets, mattresses, bedsheets, etc Thaipolyester" data-fancybox="gallery">
                                <picture>
                                    <source srcset="/assets/images/psf/mobile/Home-furnishings-for-carpets,-mattresses,-bedsheets,-etc-Thaipolyester.webp"  media="(max-width: 640px)" loading="lazy">
                                    <img src="/assets/images/psf/desktop/Home-furnishings-for-carpets,-mattresses,-bedsheets,-etc-Thaipolyester.webp" width="900" height="350" class="img-fluid" alt="Home furnishings for carpets, mattresses, bedsheets, etc Thaipolyester" loading="lazy">
                                </picture>
                                <div class="text d-flex">
                                    <p>
                    ...
                    <div class="item p-0">
                        <div class="content bg-white">
                            <a href="/assets/images/psf/desktop/Furniture-for-sofa-filling-Thaipolyester-ใหญ่.webp" title="Furniture for sofa filling Thaipolyester" data-fancybox="gallery">
                                <picture>
                                    <source srcset="/assets/images/psf/mobile/Furniture-for-sofa-filling-Thaipolyester.webp"  media="(max-width: 640px)" loading="lazy">
                                    <img src="/assets/images/psf/desktop/Furniture-for-sofa-filling-Thaipolyester.webp" width="900" height="350" class="img-fluid" alt="Furniture for sofa filling Thaipolyester" loading="lazy">
                                </picture>
                                <div class="text d-flex">
                                    <p>
                    ...
                    <div class="item p-0">
                        <div class="content bg-white">
                            <a href="/assets/images/psf/desktop/Automotive-industry-Thaipolyester-ใหญ่.webp" title="Automotive industry Thaipolyester" data-fancybox="gallery">
                                <picture>
                                    <source srcset="/assets/images/psf/mobile/Automotive-industry-Thaipolyester.webp"  media="(max-width: 640px)" loading="lazy">
                                    <img src="/assets/images/psf/desktop/Automotive-industry-Thaipolyester.webp" width="900" height="350" class="img-fluid" alt="Automotive industry Thaipolyester" loading="lazy">
                                </picture>
                                <div class="text d-flex">
                                    <p>
                                        - Automotive industry
                    ...
                    <div class="item p-0">
                        <div class="content bg-white">
                            <a href="/assets/images/psf/desktop/Construction-industry-Polyester-ใหญ่.webp" title="Construction industry Polyester" data-fancybox="gallery">
                            <picture>
                                <source srcset="/assets/images/psf/mobile/Construction-industry-Polyester.webp"  media="(max-width: 640px)" loading="lazy">
                                <img src="/assets/images/psf/desktop/Construction-industry-Polyester.webp" width="900" height="350" class="img-fluid" alt="Construction industry Polyester" loading="lazy">
                            </picture>
                            <div class="text d-flex">
                                <p>
                    ...
                    <div class="item p-0">
                        <div class="content bg-white">
                            <a href="/assets/images/psf/desktop/Rope-industry-Thaipolyester-ใหญ่.webp" title="Rope industry Thaipolyester" data-fancybox="gallery">
                                <picture>
                                    <source srcset="/assets/images/psf/mobile/Rope-industry-Thaipolyester.webp"  media="(max-width: 640px)" loading="lazy">
                                    <img src="/assets/images/psf/desktop/Rope-industry-Thaipolyester.webp" width="900" height="350" class="img-fluid" alt="Rope industry Thaipolyester" loading="lazy">
                                </picture>
                                <div class="text d-flex">
                                    <p>
                                        - Rope industry
                    ...
                    <div class="item p-0">
                        <div class="content bg-white">
                            <a href="/assets/images/psf/desktop/Glove-and-sock-industry,-including-industrial-gloves-and-agricultural-gloves-Thaipolyester-ใหญ่.webp" title="Glove and sock industry, including industrial gloves and agricultural gloves Thaipolyester" data-fancybox="gallery">
                                <picture>
                                    <source srcset="/assets/images/psf/desktop/Glove-and-sock-industry,-including-industrial-gloves-and-agricultural-gloves-Thaipolyester.webp"  media="(max-width: 640px)" loading="lazy">
                                    <img src="/assets/images/psf/desktop/Glove-and-sock-industry,-including-industrial-gloves-and-agricultural-gloves-Thaipolyester.webp" width="900" height="350" class="img-fluid" alt="Glove and sock industry, including industrial gloves and agricultural gloves Thaipolyester" loading="lazy">
                                </picture>
                                <div class="text d-flex">
                                    <p>
                    ...
                    <div class="content_group d-flex">
                        <div class="content m-auto">
                            <picture class="m-auto">
                                <source srcset="/assets/images/psf/mobile/Polyester-yarn-machine-Thaipolyester.webp" media="(max-width: 640px)">
                                <img src="/assets/images/psf/desktop/Polyester-yarn-machine-Thaipolyester.webp" alt="polyester yarn machine Thaipolyester" width="900" height="350" class="img-fluid" loading="lazy">
                            </picture>
                        </div>
                    </div>
                </div>
                ...
                <div class="owl-carousel owl-theme">
                    <div class="item r1 p-0">
                        <div class="row d-flex">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6 col2 d-flex m-auto">
                                <picture class="m-auto">
                                    <source srcset="/assets/images/psf/mobile/PSF-Product-Thaipolyester-6.webp"  media="(max-width: 640px)" loading="lazy">
                                    <img src="/assets/images/psf/desktop/PSF-Product-Thaipolyester-6.webp" width="900" height="350" class="img-fluid" alt="PSF Product Thaipolyester" loading="lazy">
                                </picture>
                            </div>
                        </div>
                    </div>
                    <div class="item r2 p-0">
                        <div class="row d-flex">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6 col2 d-flex m-auto">
                                <picture class="m-auto">
                                    <source srcset="/assets/images/psf/mobile/PSF-Product-Thaipolyester-7.webp"  media="(max-width: 640px)" loading="lazy">
                                    <img src="/assets/images/psf/desktop/PSF-Product-Thaipolyester-7.webp" width="900" height="350" class="img-fluid" alt="PSF Product Thaipolyester" loading="lazy">
                                </picture>
                            </div>
                        </div>
                    </div>
                    <div class="item r3 p-0">
                        <div class="row d-flex">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6 col2 d-flex m-auto">
                                <picture class="m-auto">
                                    <source srcset="/assets/images/psf/mobile/PSF-Product-Thaipolyester-8.webp"  media="(max-width: 640px)" loading="lazy">
                                    <img src="/assets/images/psf/desktop/PSF-Product-Thaipolyester-8.webp" width="900" height="350" class="img-fluid" alt="PSF Product Thaipolyester" loading="lazy">
                                </picture>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="owl-carousel owl-theme">
                            <div class="item p-0 d-flex">
                                <div class="block1 d-flex">
                                    ...
                                    <div class="content mb-0 d-flex">
                                        <picture class="m-auto">
                                            <source srcset="/assets/images/psf/mobile/Pre-Oriented-Yarn-(POY)-Polyester-Thaipolyester-ใหญ่.webp"  media="(max-width: 640px)" loading="lazy">
                                            <img src="/assets/images/psf/desktop/Pre-Oriented-Yarn-(POY)-Polyester-Thaipolyester-ใหญ่.webp" width="900" height="350" class="img-fluid" alt="Pre Oriented Yarn (POY) Polyester Thaipolyester" loading="lazy">
                                        </picture>
                                    </div>
                                </div>
                            </div>
                            <div class="item p-0 d-flex">
                                <div class="block2 d-flex">
                                    ...
                                    <div class="content mb-0 d-flex">
                                        <picture class="m-auto">
                                            <source srcset="/assets/images/psf/mobile/Drawn-Textured-Yarn-(DTY)-product-polyester-yhaipolyester-ใหญ่.webp"  media="(max-width: 640px)" loading="lazy">
                                            <img src="/assets/images/psf/desktop/Drawn-Textured-Yarn-(DTY)-product-polyester-yhaipolyester-ใหญ่.webp" width="900" height="350" class="img-fluid" alt="Drawn Textured Yarn (DTY) Product Polyester Thaipolyester" loading="lazy">
                                        </picture>
                                    </div>
                                </div>
                            </div>
                            <div class="item p-0 d-flex">
                                <div class="block3 d-flex">
                                    ...
                                    <div class="content mb-0 d-flex">
                                        <picture class="m-auto">
                                            <source srcset="/assets/images/psf/mobile/FDY-(full-draft-yarn)-and-Fully-Drawn-Yarn-(FDY)-Product-polyester-Thaipolyester-ใหญ่.webp"  media="(max-width: 640px)" loading="lazy">
                                            <img src="/assets/images/psf/desktop/FDY-(full-draft-yarn)-and-Fully-Drawn-Yarn-(FDY)-Product-polyester-Thaipolyester-ใหญ่.webp" width="900" height="350" class="img-fluid" alt="FDY (full-draft-yarn) and Fully Drawn Yarn (FDY) Product polyester Thaipolyester" loading="lazy">
                                        </picture>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="owl-carousel owl-theme">
                            <div class="item r1 p-0">
                                <div class="img_block d-flex">
                                    <picture class="m-auto">
                                        <source srcset="/assets/images/psf/mobile/PSF-Product-Thaipolyester-1.webp"  media="(max-width: 640px)" loading="lazy">
                                        <img src="/assets/images/psf/desktop/PSF-Product-Thaipolyester-1.webp" width="900" height="350" class="img-fluid" alt="PSF Product" loading="lazy">
                                    </picture>
                                </div>
                            </div>
                            <div class="item r1 p-0">
                                <div class="img_block d-flex">
                                    <picture class="m-auto">
                                        <source srcset="/assets/images/psf/mobile/PSF-Product-Thaipolyester-2.webp"  media="(max-width: 640px)" loading="lazy">
                                        <img src="/assets/images/psf/desktop/PSF-Product-Thaipolyester-2.webp" width="900" height="350" class="img-fluid" alt="PSF Product" loading="lazy">
                                    </picture>
                                </div>
                            </div>
                            <div class="item r1 p-0">
                                <div class="img_block d-flex">
                                    <picture class="m-auto">
                                        <source srcset="/assets/images/psf/mobile/PSF-Product-Thaipolyester-3.webp"  media="(max-width: 640px)" loading="lazy">
                                        <img src="/assets/images/psf/desktop/PSF-Product-Thaipolyester-3.webp" width="900" height="350" class="img-fluid" alt="PSF Product" loading="lazy">
                                    </picture>
                                </div>
                            </div>
                        </div>
                        ...
                        <tbody>
                            <tr>
                                <td rowspan="2" class="fw-600">
                                    <div class="img_block d-flex">
                                        <picture class="m-auto">
                                            <source srcset="/assets/images/psf/mobile/PSF-Product-Thaipolyester-4.webp" alt="PSF Virgin" media="(max-width: 640px)" loading="lazy">
                                            <img src="/assets/images/psf/desktop/PSF-Product-Thaipolyester-4.webp" width="900" height="350" class="img-fluid ab-img" alt="PSF Virgin" loading="lazy">
                                        </picture>
                                    </div>
                                    PSF<br> Virgin
                                </td>
                            ...
                            <tr>
                                <td rowspan="2" class="fw-600">
                                    <div class="img_block d-flex">
                                        <picture class="m-auto">
                                            <source srcset="/assets/images/psf/mobile/PSF-Product-Thaipolyester-5.webp" alt="PSF Recycled" media="(max-width: 640px)" loading="lazy">
                                            <img src="/assets/images/psf/desktop/PSF-Product-Thaipolyester-5.webp" width="900" height="350" class="img-fluid ab-img" alt="PSF Recycled" loading="lazy">
                                        </picture>
                                    </div>
                                    PSF<br> Recycled
                                </td>
...
@section('custom-script')
	...
	<script src="/js/psf.min.js?v={{time()}}"></script>
