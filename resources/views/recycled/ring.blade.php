                                ...
                                <div class="shop_single">
                                    <div id="product-3981" class="post-3981 product type-product status-publish has-post-thumbnail product_cat-general product_tag-invitation first instock shipping-taxable purchasable product-type-simple">
                                        ...
                                        <div class="summary entry-summary">
                                            <h1 class="product_title entry-title">100% Recycled Ring Spun</h1>
                                            <p class="price"><span class="woocommerce-Price-amount amount">Semi dull , Raw white / Dope dye black / Dope dye color, Melange</span>
                                            </p>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-sm pc-margin-top15 text-nowrap">
                                                ...
                                                <tr>
                                                    <td><p style="font-size:14px;">10/1<br><br>20/1</p></td>
                                                    <td><p style="font-size:14px;">12/1<br><br>28/1 </p></td>
                                                    <td><p style="font-size:14px;">14/1<br><br>30/1 </p></td>
                                                    <td><p style="font-size:14px;">18/1<br><br>32/1</p></td>
                                                </tr>
                                                <tr>
