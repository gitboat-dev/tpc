...
function sectwo(){
	var row1_1 = jQuery('.section-two .r1 .block .col1 .col1-1'),
		row1_2 = jQuery('.section-two .r1 .block .col1 .col1-2'),
		row1_3 = jQuery('.section-two .r1 .block .col1 .col1-3'),
		row1_4 = jQuery('.section-two .r1 .block .col1 .col1-4'),
		row2_1 = jQuery('.section-two .r2 .block .col2 .col2-1'),
		row2_2 = jQuery('.section-two .r2 .block .col2 .col2-2'),
		minheight4 = jQuery(row1_4).outerHeight();
	minheight4 = minheight4 > 300 ? minheight4 : 300;
	if(jQuery( window ).width() <= 991 || jQuery( window ).width() > 1693){
		jQuery(row1_1).css({'min-height':minheight4+'px'});
		jQuery(row1_2).css({'min-height':minheight4+'px'});
		jQuery(row1_3).css({'min-height':minheight4+'px'});
		jQuery(row1_4).css({'min-height':minheight4+'px'});
		jQuery(row2_1).css({'min-height':minheight4+'px'});
		jQuery(row2_2).css({'min-height':minheight4+'px'});
	}else if(jQuery( window ).width() <= 1693){
		jQuery(row1_1).css({'min-height':minheight4+'px'});
		jQuery(row1_2).css({'min-height':minheight4+'px'});
		jQuery(row1_3).css({'min-height':minheight4+'px'});
		jQuery(row1_4).css({'min-height':minheight4 + 25+'px'});
		jQuery(row2_1).css({'min-height':minheight4+'px'});
		jQuery(row2_2).css({'min-height':minheight4+'px'});
	}	
}
function secfour(){
	var row1 = jQuery('.section-four .r1 .col1 .col1-1 .contact_logo .col1'),
		row2 = jQuery('.section-four .r1 .col1 .col1-1 .contact_logo .col2'),
