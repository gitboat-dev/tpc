			...
			'imageAttributes': function (context) {
				...
				context.memo('button.imageAttributes', function () {
					var button = ui.button({
						...
						container: false,
						tooltip: lang.imageAttributes.tooltip+' SEO',
						click: function () {
				...
				this.initialize = function () {
					...
					var body = `<div class="row">
									<div class="form-group col-sm-12">
										...
										placeholder="ชื่อรูปภาพ (SEO title)"/>
									</div>
									<div class="form-group col-sm-12">
										...
										placeholder="คำอธิบายรูปภาพ (SEO alt)"/>
									</div>
									<div class="form-group col-sm-12">
									...
									<div class="form-group col-sm-4">
										...
										<div>
											...
											<button type="button" class="btn btn-default btn-md reset-size-buttton" aria-label="Resize" data-toggle="tooltip" title="${lang.imageAttributes.resizeLabel}">
												<span class="glyphicon glyphicon-repeat" aria-hidden="true"><i class="fa fa-refresh" aria-hidden="true"></i></span>
											</button>
										</div>
									</div>
								</div>`;
								...
								// 	<label class="note-form-label">${lang.imageAttributes.hrefLabel}</label>
								// 	<input class="form-control note-input note-image-href-text" type="text" 
								// 	placeholder="link รูปภาพ เช่น www.google.com" style="width:95%;"/>
								// </div>`;
					...
					this.showLinkDialog(_imgInfo)
						.then(function (imgInfo) {
							...
							if (_imgInfo.title != imgInfo.title || _imgInfo.alt != imgInfo.alt || _imgInfo.caption != imgInfo.caption
								|| _imgInfo.width != imgInfo.width || _imgInfo.height != imgInfo.height || _imgInfo.href != imgInfo.href) {
				...
				this.showLinkDialog = function (imgInfo) {
					return $.Deferred(function (deferred) {
						...
						var $imageHref = self.$dialog.find('.note-image-href-text');
						...
						ui.onDialogShown(self.$dialog, function () {
							...
							$imageHref.val(imgInfo.href);
							self.bindEnterKey($imageHref, $editBtn);
